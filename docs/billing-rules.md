...
| Tax and legal scope | France-first current party profiles are confirmed above. Which tax modes, VAT exemption/reverse-charge mentions, invoice-level structured operation category, goods-delivery address, VAT-on-debits option, required sector/activity registrations or insurance, and retention rules apply to issuance? These remain invoice/issuance decisions, not live profile defaults. |
